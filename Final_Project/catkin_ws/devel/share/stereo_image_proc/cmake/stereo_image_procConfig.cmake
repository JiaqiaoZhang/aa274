...
if("TRUE" STREQUAL "TRUE")
  set(stereo_image_proc_SOURCE_PREFIX /home/aa274/catkin_ws/src/image_pipeline/stereo_image_proc)
  set(stereo_image_proc_DEVEL_PREFIX /home/aa274/catkin_ws/devel)
  ...
  set(stereo_image_proc_INSTALL_PREFIX /home/aa274/catkin_ws/install)
...
if(NOT "/home/aa274/catkin_ws/devel/include;/home/aa274/catkin_ws/src/image_pipeline/stereo_image_proc/include " STREQUAL " ")
  set(stereo_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/aa274/catkin_ws/devel/include;/home/aa274/catkin_ws/src/image_pipeline/stereo_image_proc/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stereo_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aa274/catkin_ws/src/image_pipeline/stereo_image_proc/${idir}'.  ${_report}")
    endif()
